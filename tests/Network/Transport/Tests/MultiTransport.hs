...
-- | Basic ping test
testPingPong :: Transport -> Transport -> Int -> IO ()
testPingPong transport1 transport2 numPings = do
...
testEndPoints :: Transport -> Transport -> Int -> IO ()
testEndPoints transport1 transport2 numPings = do
  server <- spawn transport1 echoServer
...
testConnections :: Transport -> Transport -> Int -> IO ()
testConnections transport1 transport2 numPings = do
  server <- spawn transport1 echoServer
  result <- newEmptyMVar
...
testCloseOneConnection :: Transport -> Transport -> Int -> IO ()
testCloseOneConnection transport1 transport2 numPings = do
  server <- spawn transport1 echoServer
  result <- newEmptyMVar
...
testCloseOneDirection :: Transport -> Transport -> Int -> IO ()
testCloseOneDirection transport1 transport2 numPings = do
  addrA <- newEmptyMVar
  addrB <- newEmptyMVar
  doneA <- newEmptyMVar
  doneB <- newEmptyMVar
...
testCloseReopen :: Transport -> Transport -> Int -> IO ()
testCloseReopen transport1 transport2 numPings = do
  addrB <- newEmptyMVar
  doneB <- newEmptyMVar
...
testParallelConnects :: Transport -> Transport -> Int -> IO ()
testParallelConnects transport1 transport2 numPings = do
  server <- spawn transport1 echoServer
  done   <- newEmptyMVar
